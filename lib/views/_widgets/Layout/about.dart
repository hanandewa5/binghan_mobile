...
class _AboutCarouselState extends State<AboutCarousel> {
  ...
  Widget carouselImage(List carouselList, MediaQueryData mediaQuery) {
    ...
    final child = map<Widget>(carouselList, (index, var i) {
      return SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(child: Image.asset(carouselList[index]["imgUrl"])),
              Text(
                ...
                itemBuilder: (context, i) {
                  return Column(
                    ...
                    children: <Widget>[
                      Paragraft(
                        textStyle:
                            carouselList[index]["descriptions"][i]["style"],
    ...
    return CarouselAbout(items: child);
  }
}

class IconText extends StatelessWidget {
  const IconText({this.iconData, this.text, this.onPress, super.key});
