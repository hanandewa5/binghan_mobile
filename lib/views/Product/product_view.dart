...
class _ProductState extends State<Product> {
                    ...
                    child: LoaderListPage(
                      ...
                      child: GridView.builder(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: 2,
                            childAspectRatio: ((_width) / (_width + 70))),
                            ...
                            child: GestureDetector(
                              onTap: () {
                                model.goToProductDetail(
                                    model.listProductItem[index].id);
                              },
                              child: buildCard(
                                  _width, model, index, _colorPrimary),
                            ),
                          );
                        },
                      ),
  ...
  Card buildCard(
      double _width, ProductViewModel model, int index, Color _colorPrimary) {
    return Card(
      elevation: 5,
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: ClipRRect(
                ...
                child: Hero(
                  ...
                  child: FadeInImage(
                    image: NetworkImage(model.listProductItem[index].imageUrl),
                    fit: BoxFit.cover,
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text(model.listProductItem[index].name,
                    overflow: TextOverflow.ellipsis,
                    maxLines: 2,
                    style: textMedium.merge(MyColors.ColorInputPrimary)),
                Text(formatIDR(model.listProductItem[index].price),
                    style: textMedium.merge(MyColors.ColorInputPrimary)),
              ],
            )
          ],
