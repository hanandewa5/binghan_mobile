...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Widget build(BuildContext context) {
    return BaseView<ProductViewModel>(
        ...
        builder: (context, model, child) {
          ...
          return Scaffold(
            bottomNavigationBar:
                BottomBar(width: _width, colorPrimary: _colorPrimary, model: model),
            body: Stack(
              children: <Widget>[
                SingleChildScrollView(
                    child: (model.isItemDetail)
                        ? buildContent(model, context, _colorPrimary, _colorAccent)
                        : loader(context)),
                buildAppbar(model),
              ],
            ),
  ...
  Widget buildContent(
      ProductViewModel model, BuildContext context, Color _colorPrimary, Color _colorAccent) {
    return Column(
      children: <Widget>[
        Hero(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    fit: BoxFit.cover, image: NetworkImage(model.itemDetail.imageUrl))),
          ),
        ),
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  Paragraft(
                    text: formatIDR(model.itemDetail.price),
              ...
              Paragraft(
                text: "Pop Disc : ${formatIDR(model.itemDetail.popDiscount)}",
                textStyle: textThin,
                fontSize: 18,
              ),
              // Paragraft(
              ...
              FindDropdown<ListDownline>(
                ...
                dropdownItemBuilder: (BuildContext context, ListDownline data, bool isSel) {
                  return Container(
                    child: ListTile(
                      ...
                      title: Column(
                        ...
                        children: <Widget>[
                          ...
                          Paragraft(
                            text: "Up  : ${data.sponsorBinghanId}-${data.namaSponsor}",
                            textStyle: textThin,
                          )
                        ],
                      ),
...
class BottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      height: 80.0,
      decoration: BoxDecoration(
          color: Colors.white, boxShadow: [BoxShadow(color: Colors.black45, blurRadius: 5)]),
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: model.busy || model.itemDetail.stockAvailable <= 0
                  ? null
                  : () {
                      model.addCart();
                    },
