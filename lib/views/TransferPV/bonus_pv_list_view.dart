...
class BonusPVListView extends StatefulWidget {
  const BonusPVListView({Key key}) : super(key: key);

  @override
  _BonusPVListViewState createState() => _BonusPVListViewState();
}
                    ...
                    child: Column(
                      children: <Widget>[
                        InputDate(
                          ...
                          onChange: model.setStartDateBonus,
                          formatDate: [MM, " ", yyyy],
                        ),
                        InputDate(
                          name: "End Date",
                          ...
                          formatDate: [MM, " ", yyyy],
                          onChange: model.setEndDateBonus,
                        ),
                      ],
                    ),
                  ),
                                ...
                                children: <Widget>[
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Paragraft(
                                        ...
                                        fontSize: 18,
                                        text: "Ke : ${model.listBonus[i].diTransferKe}",
                                  ...
                                  Paragraft(
                                    text: "Jumlah yang di transfer " +
                                        formatIDR(model.listBonus[i].jumlahDiTransfer),
    ...
    return new Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Paragraft(
              text: formatIDR(model.totalBonus),
            )
          ],
        ));
  }
