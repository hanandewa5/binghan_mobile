...
class CartList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color _colorPrimary = Theme.of(context).primaryColor;
    return Container(
        child: Padding(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color: _colorPrimary, shape: BoxShape.circle),
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Paragraft(
                          text: "${model.listManifest[i].manifestDescription}",
                          color: Colors.black54,
                          textStyle: textThin,
                        ),
